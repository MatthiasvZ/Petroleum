...
INC = 
CFLAGS = -Wall -m64 -fexceptions -march=native -pipe
RESINC = 
LIBDIR = 
LIB = 
LDFLAGS = -m64 -lglfw -lGLEW -lX11 -lGLU -lGL
...
OBJDIR_RELEASE = obj
DEP_RELEASE = 
OUT_RELEASE = bin/libPetroleum.a
...
OBJ_RELEASE = $(OBJDIR_RELEASE)/src/gl/VertexBuffer.o $(OBJDIR_RELEASE)/src/gl/Window.o $(OBJDIR_RELEASE)/src/other/ErrorFeedback.o $(OBJDIR_RELEASE)/src/other/FileManagement.o $(OBJDIR_RELEASE)/src/gl/VertexArray.o $(OBJDIR_RELEASE)/src/vendor/stb_image/stb_image.o $(OBJDIR_RELEASE)/src/gl/IndexBuffer.o $(OBJDIR_RELEASE)/src/gl/Renderer.o $(OBJDIR_RELEASE)/src/gl/Shader.o $(OBJDIR_RELEASE)/src/gl/Texture.o
